...
def dft(options, wisdom=None):
    ...
    for i in range(it+1):
        ...
        tt1, v[...] = time_stepping.fourier_ps(delta, k4, k2, tpiL, dt, u, fft_object, ifft_object, v, vpp)
        t1 += tt1
        ...
        tt3, u[...] = time_stepping.fourier_ps(delta, k4, k2, tpiL, dt, v, fft_object, ifft_object, u, vp)
        t3 += tt3
